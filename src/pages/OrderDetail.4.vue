<template>
  <div class="page scroll"  style="position: absolute;">
    <page-content>
      <div class="orderDetail">
        ...
        <div v-if="type === 2" class="orderDetail-dailyWrap">
          <div class="order-daily__slecetDay">
            ...
            <div @click="timePickerOne = true;" class="item-input" style="font-size:14px"> {{filterBegin}} </div>
            <van-popup v-model="timePickerOne" position="bottom">
