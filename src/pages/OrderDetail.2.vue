    ...
    <page-content>
      <div class="orderDetail">
        ...
        <div v-if="type === 1" class="orderDetail-monthWrap">
          ...
          <div ref="mescroll" class="mescroll" style="margin-top:3rem;height: 400px; overflow: auto;">
			      <div>
			      <!--内容...-->
              <div v-for="item in dataList" :key="item.index" class="orderDetail-list__detail">
                ...
                <div class="orderDetail-list__sum">
                  ...
                  <a @click="handleDetail(item.id, item.status)" style="align-self:center">详情</a>
                </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      upCallback(page) {
        //联网请求
        axios.get("api/app/service_department/monthly_payment.htm", {
          params: {
            pageNumber: 1, 
            status: this.id, 
