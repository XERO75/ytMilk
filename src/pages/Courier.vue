<template>
  <div class="page">
    ...
    <div class="courier-header">
      <div :class="{'courier-header__active': type == 1}" @click="getList()" class="courier-header__list">配送员列表</div>
      <div :class="{'courier-header__active': type == 2}" @click="getCount()" class="courier-header__deliveryCount">配送员送奶统计</div>
    </div>
    <div v-if="type === 1" class="courier-ListWrap">
      <div class="courier-subHeader">
        <div class="courier-subHeader__inputWrap">
          <form class="courier-search__form" action="javascript:;" onsubmit="return false;">
            <input class="courier-search__input" type="text" ref="searchInput" autofocus @focus="isFocus = true" @blur="isFocus = false" placeholder="搜索关键字和号码">
          </form>
    ...
    <div v-if="type === 2" class="courier-countWrap">
      <div class="courier-count__header">
        <select class="courier-count__selectbox" v-model="selected">
